...
public class MusicBot {
    ...
    public static void main(String[] args) {
        ...
        File groupFile = new File("groupList.txt");
        Path groupFilePath = Paths.get("groupList.txt");
        ...
        soru = scan.nextLine().replaceAll("\\s+", "");
        ...
        String bandName = bandNameChecker.check();
        keywords.add(bandName);
